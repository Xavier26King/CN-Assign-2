...
def create_topology():
    ...
    # Start TCP clients on h1-h6
    print("*** Starting TCP clients on h1-h6")
    for client in [h1, h2, h3, h4, h5, h6]:
        client.cmd(f'iperf3 -c 10.0.0.7 -p 6633 -b 10M -P 10 -t 150 -C bbr &')
